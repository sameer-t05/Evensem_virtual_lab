...
canvas.getBoundingClientRect = () => ({ left: 0, top: 0, width: 1200, height: 736 });
...
mouse.pixelRatio = 2; // window.devicePixelRatio
// NOT setting render.mouse = mouse, so Render.world never scales it!
